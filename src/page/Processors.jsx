...
function Processors() {
  ...
  useEffect(() => {
    axios.get("https://bonik-project.onrender.com/processors").then((res) => {
      setUsers(res.data);
    });
  }, []);
        ...
        <div className="container-footer">
          <ul>
            ...
            <p>
              ...
              умные решения. Качество, надежность и быстрая <br /> доставка— всё
              в одном месте. Выбирайте <br /> технологии с умом — выбирайте
              BONIK.
            </p>
